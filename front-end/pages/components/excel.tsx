...
export default function Excel(props: Excelprops) {
                ...
                for (const sheet in workbook.Sheets) {
                    if (workbook.Sheets.hasOwnProperty(sheet)) {
                        ...
                        for (const item of arrs) {
                            ...
                            const _addr = vals[0];
                            const _tokenId = vals[1];

                            objs.push([_addr, _tokenId]);
                        }
    ...
    const fillExampleDataFunc = () => {
        const exampleData = [
            { address: "0x0000000000000000000000000000000000000000", tokenId: "1" },
            { address: "0x0000000000000000000000000000000000000001", tokenId: "2" },
        ]
